...
class cSheet_survey_45 extends cSheetITS
{
	private	$name = 'VI129';

	public function /* void */ Create()
	{
		$this->SetHeader('<div class="descr"><p>What percentage change (positive or negative) in market net rental rates do you expect for each of the following markets?<br /><strong><em>Please use decimals where possible</em></strong></p></div>');
	...
	{
		$this->DrawInputMatrix_Arr3_C($this->name, 'Single-Tenant Industrial Net Rental Rate Change<br />% Change (Positive or Negative)');
	}
